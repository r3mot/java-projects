...
public class Query {
    ...
    public static final String GET_CLUBS_JOIN = "SELECT FRINED_EMAIL, FRIEND_NAME, FRIEND_PURPOSE, FRIEND_CONTACT, FRIEND_WEBSITE, FRIEND_ICON FROM FRIENDS WHERE CURRENT_USER=?";
    // FEED
